...
#Summary of the day
print(f"Today's step count: {steps}\n Hours of sleep: {sleep_hours} hours\n Water glasses consumed: {water_glasses} glasses\n Cold shower taken: {cold_shower}\n Pages read: {page_read} pages")  
print(f"Today I walked {steps} steps, slept for {sleep_hours} hours, drank {water_glasses} glasses of water, took a cold shower: {cold_shower} and read {page_read} pages of the 48 Laws of power.")